        ...
        reader.onload = async (e: ProgressEvent<FileReader>) => {
            ...
            if (result && typeof result !== 'string') {
                ...
                try {
                    ...
                    const response = await axios.post('/api/enrollment/unenroll-users', {
                        users: jsonData,     
                        idOfCourse:courseId                   
                    });
                    ...
                    if (response.status === 201) {
                        ...
                        alert('Failed to unenroll course users');
                        console.error('Failed to remove course users');
                    }
                } catch (error) {
...
export default ExcelUnEnrollComponent