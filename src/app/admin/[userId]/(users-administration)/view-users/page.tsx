                    ...
                    <div>
                        ...
                        <div className="flex flex-col sm:flex-row justify-between items-center mb-4 gap-4">
                            <input
                                ...
                                className="w-full sm:w-2/3 px-4 py-2 border border-gray-200 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-[#151b23] text-gray-700 dark:text-gray-200 bg-gray-100"
                            />
                            <select
                                value={selectedRole}
