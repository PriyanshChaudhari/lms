    ...
    return (
        <div className="border border-gray-300 dark:bg-[#212830] m-5 max-h-full flex justify-center items-center">
            <div className="w-full max-w-4xl mx-auto p-5">
                ...
                <nav className="mb-6 border {/*border-gray-300*/} rounded-xl shadow-md p-2 dark:bg-[#212830]">
                ...
                <div className="space-y-4">
                    ...
                    {activeSection === 'users' && (
                        <div className="space-y-4 dark:bg-[#212830]">
                            ...
                            <div className="space-y-4 justify-between mb-4">
                                <div className="bg-white dark:bg-[#212830] border {/*border-gray-300*/} rounded-xl p-3 shadow-md h-12" onClick={handleCreateUserClick}>
                                    <h2 className="text-base font-semibold mb-2 cursor-pointer w-fit">Create User</h2>
                                </div>

                                <div className="bg-white dark:bg-[#212830] border {/*border-gray-300*/} rounded-xl p-3 shadow-md h-12 " onClick={handleUploadUsersClick}>
                                    <h2 className="text-base font-semibold mb-2 cursor-pointer w-fit">Upload Users</h2>
                                </div>

                                <div className="bg-white dark:bg-[#212830] border {/*border-gray-300*/} rounded-xl p-3 shadow-md h-12 " onClick={handleViewUsersClick}>
                                    <h2 className="text-base font-semibold mb-2 cursor-pointer w-fit">View Users</h2>
                                </div>

                                <div className="bg-white dark:bg-[#212830] border {/*border-gray-300*/} rounded-xl p-3 shadow-md h-12 " onClick={handleDeleteUsersClick}>
                    ...
                    {activeSection === 'course' && (
                        <div className="space-y-4 ">
                            ...
                            <div className="space-y-4 justify-between mb-4">
                                <div className="bg-white dark:bg-[#212830] border border-gray-300 rounded-xl p-3 shadow-md h-12" onClick={handleCreateCategoryClick}>
                                    <h2 className="text-base font-semibold mb-2 cursor-pointer w-fit">Add Category</h2>
                                </div>

                                <div className="bg-white dark:bg-[#212830] border border-gray-300 rounded-xl p-3 shadow-md h-12 " onClick={handleModifyCategoryClick}>
                    ...
                    {activeSection === 'groups' && (
                        <div className="space-y-16">
                            <div className="space-y-4 ">
                                ...
                                <div className="space-y-4 justify-between mb-4">
                                    <div className="bg-white dark:bg-[#212830] border border-gray-300 rounded-xl p-3 shadow-md h-12" onClick={() => { router.push(`/admin/${userId}/groups/create-group`) }}>
                                        <h2 className="text-base font-semibold mb-2 cursor-pointer w-fit">Create Group</h2>
                                    </div>

                                    <div className="bg-white dark:bg-[#212830] border border-gray-300 rounded-xl p-3 shadow-md h-12 " onClick={() => { router.push(`/admin/${userId}/groups`) }}>
