                ...
                <div className="space-y-4 ">
                    ...
                    <div>
                        <button
                            ...
                            onClick={() => router.push(params.moduleId ? `/student/${userId}/mycourse/${courseId}/modules/${moduleId}/assignments/${assignmentId}/add-submission` : `/student/${userId}/mycourse/${courseId}/assignments/${assignmentId}/add-submission`)}
                        >
                            Add Submission
                        </button>
                    </div>
