    ...
    return (
        <div className="border border-gray-300 m-5">
            <div className="max-w-4xl mx-auto p-5">
                ...
                <p className="text-lg text-gray-700 dark:text-gray-500 mb-6">Description of module 1</p>
                <nav className="mb-6 p-2">
                    <ul className="flex justify-start space-x-4 list-none p-0">
                        ...
                        <li className=" p-3 rounded-xl text-black dark:text-gray-300 cursor-pointer">Module 1</li>
                    </ul>
                </nav>
