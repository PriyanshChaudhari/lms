            ...
            <div className="max-w-4xl mx-auto p-5">
                ...
                <nav className="mb-6 p-2">
                    <ul className="flex justify-start space-x-4 list-none p-0">
                        <li className=" p-3 rounded-xl text-gray-500 cursor-pointer" onClick={() => router.push(`/student/viewsection`)}>Course 1</li>
                        <li className=" p-3 rounded-xl text-black cursor-pointer">/</li>
                        <li className=" p-3 rounded-xl text-gray-500 cursor-pointer" onClick={() => router.push(`/student/viewmodule`)}>Module 1</li>
                        <li className=" p-3 rounded-xl text-black cursor-pointer">/</li>
                ...
                <div className="space-y-4 ">
                    ...
                    <div>
                        <button className="bg-black text-white rounded-xl p-3 my-5" onClick={() => router.push(`/student/assignmentsubmission`)}>Add Submission</button>
                    </div>
                    <div className="bg-white border border-gray-300 rounded-xl p-6 shadow-md h-26">
                        <h2 className="text-xl font-semibold mb-2">Assignment Description</h2>
                        <p className="text-sm text-gray-600">Opened: 30 OCT</p>
