                    ...
                    <div>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="flex justify-between mt-4">
                                <button type="submit" className="bg-black text-white py-2 px-7 rounded-xl dark:hover:bg-[#1a1a1a] transition">Save</button>
                                <button type="button" className="bg-gray-300 dark:bg-white text-black border border-gray-300 py-2 px-4 rounded-xl hover:bg-gray-400 dark:hover:bg-gray-100 transition" onClick={() => setFiles([])}>Cancel</button>
                            </div>
                        </form>
                    </div>
                </div>
